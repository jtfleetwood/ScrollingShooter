...
public class SoundEngine {
    ...
    // Passing in context to let us know the current state of the application/object.
    SoundEngine(Context c) {
        ...
        try {
            ...
            // Returning int values to our statuses that let our SoundPool object know which sound to play based off the passed in status.
